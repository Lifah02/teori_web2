...
?>
    <link href="<?= Yii::$app->request->baseUrl ?>/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
     <link rel="stylesheet" href="<?= Yii::$app->request->baseUrl ?>/assets/css/templatemo-chain-app-dev.css">
    <link rel="stylesheet" href="<?= Yii::$app->request->baseUrl ?>/assets/css/animated.css">
    ...
    <!-- Scripts -->
      ...
      <script src="<?= Yii::$app->request->baseUrl ?>/assets/js/popup.js"></script>
...
<?php $this->beginBody() ?>
 ...
 <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html">Lifah</a></h1>
